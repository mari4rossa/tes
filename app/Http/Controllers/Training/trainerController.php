    ...
    public function trainerTable(Request $request){
        ...
        return Datatables::of($datas)
                    ->addColumn('action', function($row){
                        ...
                        $btn = $btn.' <a href="javascript:void(0)" data-toggle="tooltip"  data-id="'.$row->id.'" data-original-title="Delete" class="btn btn-danger btn-sm deleteTrainer">Non-aktifkan</a>';
                        return $btn;
                    })
                    ->rawColumns(['action'])
                    ->make(true);
